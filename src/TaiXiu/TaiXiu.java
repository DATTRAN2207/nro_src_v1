...
public class TaiXiu {
    ...
    public void InfoTaiXiu(Player p) {
        String text = "Thông tin phiến #" + this.phien + "\n"
                + "Tổng tiền cược Kiếm : " + this.totaltai + " Xu \n"
                + "Tổng tiền cược Tiêu : " + this.totalxiu + " Xu \n"
    ...
    private void random() {
        ...
        Manager.serverChat("Thông Báo", "Kết Quả phiến #" + this.phien + ": " + taiorxiu + " : Tổng : " + a + " + " + b + " + " + c + " = " + tongrandom);
        ...
        while (this.start == false) {
            ...
            if (this.tai == true) {
                for (int i = 0; i < this.teamtai.size(); i++) {
                    ...
                    if (c.Join > 0) {
                        LichSu.LichSuThangTaiXiu(c.name, "Thắng Kiếm Tiêu", c.xu, (c.xu + c.Join * 18 / 10), +c.Join * 18 / 10);
                        LichSu.LichSuXu(c.name, c.xu, (c.xu + (c.Join * 18 / 10)), "Thắng Kiếm Tiêu : ", +(c.Join * 18 / 10));
    ...
    public void joinTai(Player p, int JoinTai) {
        ...
        p.c.Join += JoinTai;
        LichSu.LichSuDatTaiXiu(p.c.name, "Đặt Kiếm", p.c.xu, (p.c.xu - JoinTai), -JoinTai);
        LichSu.LichSuXu(p.c.name, p.c.xu, (p.c.xu - JoinTai), "Đặt Kiếm : ", -JoinTai);
    ...
    public void joinXiu(Player p, int JoinXiu) {
        ...
        p.c.Join += JoinXiu;
        LichSu.LichSuDatTaiXiu(p.c.name, "Đặt Tiêu", p.c.xu, (p.c.xu - JoinXiu), -JoinXiu);
        LichSu.LichSuXu(p.c.name, p.c.xu, (p.c.xu - JoinXiu), "Đặt Tiêu : ", -JoinXiu);

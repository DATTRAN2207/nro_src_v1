...
public class Manager {
    ...
    public Manager() {
        ...
        this.loadConfigFile();
        this.rotationluck[0] = new Lucky("Vòng Xoay Vip", (byte) 0, (short) 120, 10000000, 50000000, 2000000000);
        this.rotationluck[1] = new Lucky("Vòng Xoay Thường", (byte) 1, (short) 120, 10000, 50000000, 1000000000);
    ...
    private void loadDataBase() {
        ...
        try {
            ...
            res.close();
            i = 0;
            for (res = SQLManager.stat.executeQuery("SELECT * FROM `gmshop`;"); res.next(); ++i) {
                Option = (JSONArray) JSONValue.parse(res.getString("ListItem"));
                if (Option != null) {
                    for (j = 0; j < Option.size(); ++j) {
                        job = (JSONObject) Option.get(j);

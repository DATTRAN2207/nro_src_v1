...
//            JOptionPane.showMessageDialog(null, "Ðang thông báo thành công");
        ...
        maintenanceButton8.addActionListener(e -> {
            ...
            if (temp != null) {
                ...
                if (banPlayer != null && banPlayer.id != 1) {
        ...
        maintenanceButton17.addActionListener(e -> {
            ...
            if (option == JOptionPane.OK_OPTION) {
                try {
                    ...
                    try {
                        PreparedStatement selectStatement = SQLManager.conn.prepareStatement("SELECT NPC FROM `nso_data`.`map` WHERE id = ?");
                      ...
                      npcData += String.format("[1,%d,%d,%d]]", xCoordinate, yCoordinate, npcId, mapId);
                        ...
                        PreparedStatement updateStatement = SQLManager.conn.prepareStatement("UPDATE `nso_data`.`map` SET NPC = ? WHERE id = ?");

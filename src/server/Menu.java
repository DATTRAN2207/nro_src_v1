...
import Task.Task;
import Task.Text;
import TowerDungeon.TowerDungeon;
...
public class Menu {
    ...
    public static void menuId(Char _char, Message ms) throws IOException { // send menu
        ...
        switch (npcId) {
            // case 32:
            // Service.chatNPC(_char.p, (short) npcId, "Thức Tỉnh Cần 100 Đá thức tỉnh +
            // 10.000.000 Xu + 10.000 Lượng . Tỉ Lệ Thành Công 7%");
            // break;
            case 33:
                switch (Server.manager.event) {
                    case EventName.SU_KIEN_DUA_HAU: // Sự Kiện Trung Thu
                        Menu.doMenuArray(_char.p, new String[] { "Bánh thập cẩm", "Bánh Dẻo", "Bánh Đậu xanh",
                                "Bánh pía", "Làm Hộp bánh thường", "Làm Hộp bánh thượng hạng", "Top", "Hướng Dẫn" });
                        break;
                    case EventName.SK_HE:// he
                        Menu.doMenuArray(_char.p,
                                new String[] { "Làm Diều Giấy", "Làm Diều Vải", "Top", "Hướng Dẫn " });
                        break;
                    case EventName.HALLOWEEN:// haloween
                        Menu.doMenuArray(_char.p,
                                new String[] { "Làm Hộp ma quỷ", "Làm Kẹo táo", "Top", "Hướng Dẫn " });
                        break;
                    case EventName.DA_MA_THUAT:
                        Menu.doMenuArray(_char.p,
                                new String[] { "Làm Giấy Thông Hành", "Làm Đá Ma Thuật", "Top", "Hướng Dẫn" });
                        break;
                    case EventName.SK_NOEL:
                        Menu.doMenuArray(_char.p,
                                new String[] { "Làm Bánh Dâu Tây", "Làm Bánh Chocolate", "Top", "Hướng Dẫn" });
                        break;
                    case EventName.SK_TET_NGUYEN_DAN:
                        Menu.doMenuArray(_char.p,
                                new String[] { "Làm Bánh Tét", "Làm Bánh Chưng", "Top", "Hướng Dẫn" });
                        break;
                }
                break;
            case 40:
            ...
            case 42:
            case 43: {
                Menu.doMenuArray(_char.p, new String[] { "trang trí" });
                break;
            }
            default:
                break;
        ...
        try {
            ...
            if ((p.typemenu == -1 || p.typemenu == 0) && p.typemenu != npcId) {
                switch (npcId) {
                    ...
                    case 50: {
                        NpcMenu.KhaiHoa(p, npcId, menuId, b3);
                        break;
                    }
                    case 51: {
                        NpcMenu.npcDevilFruit(p, npcId, menuId, b3);
                        break;
                    }
                    case 52: {
                        NpcMenu.npcKizzz(p, npcId, menuId, b3);
                        break;
                    }
                    case 53: {
                        NpcMenu.npcChanle(p, npcId, menuId, b3);
                        break;
                    }
                    case 56: {
                    ...
                    case 60: {
                        TowerDungeon.MenuTowerDungeon(p, npcId, menuId, b3);
                        break;
                    }
                    case 120: {
                ...
                switch (p.typemenu) {
                    ...
                    case 100: {
                        switch (menuId) {
                            case 0:
                                int[] xu1 = new int[] { 1000000, 1500000, 2000000, 3000000, 4000000, 5000000, 7000000,
                                        10000000, 20000000 };
                                ...
                                int capkhaihoa1 = 0;
                                Service.startYesNoDlg(p, (byte) 103, String.format("Thăng Cấp Khai Hoá Lên Cấp "
                                        + (capkhaihoa1 + 1)
                                        + "\n - Cần %d Xu Và %d Lượng %d đá Sát Thương \n - Tỉ Lệ Thành Công: %s",
                                        xu1[capkhaihoa1], luong1[capkhaihoa1], da1[capkhaihoa1],
                                        tile1[capkhaihoa1] + "%"));
                                break;
                            case 1:
                                int[] xu2 = new int[] { 1000000, 1500000, 2000000, 3000000, 4000000, 5000000, 7000000,
                                        10000000, 20000000 };
                                ...
                                int capkhaihoa2 = 0;
                                Service.startYesNoDlg(p, (byte) 104, String.format("Thăng Cấp Khai Hoá Lên Cấp "
                                        + (capkhaihoa2 + 1)
                                        + "\n - Cần %d Xu Và %d Lượng %d đá Phòng Ngự \n - Tỉ Lệ Thành Công: %s",
                                        xu2[capkhaihoa2], luong2[capkhaihoa2], da2[capkhaihoa2],
                                        tile2[capkhaihoa2] + "%"));
                                break;
                            case 2:
                                int[] xu3 = new int[] { 1000000, 1500000, 2000000, 3000000, 4000000, 5000000, 7000000,
                                        10000000, 20000000 };
                                ...
                                int capkhaihoa3 = 0;
                                Service.startYesNoDlg(p, (byte) 105, String.format("Thăng Cấp Khai Hoá Lên Cấp "
                                        + (capkhaihoa3 + 1)
                                        + "\n - Cần %d Xu Và %d Lượng %d đá Sinh Mệnh \n - Tỉ Lệ Thành Công: %s",
                                        xu3[capkhaihoa3], luong3[capkhaihoa3], da3[capkhaihoa3],
                                        tile3[capkhaihoa3] + "%"));
                                break;
                        }
                        break;

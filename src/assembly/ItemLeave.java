...
public class ItemLeave {
    ...
    public static short[] dakh = new short[]{941, 942, 943};
    //------------------------------------------------------------------------//
    ...
    public static short[] SVC12X = new short[]{895, 896, 897, 898, 899, 900};
    ...
    //-------------------------------------------------------------------------//
    public static short[] VatPhamSuKien = new short[]{292, 293, 294, 295, 296, 297};
    ...
    public static short[] NLSKDANANGLUONG = new short[]{656, 657, 658};
    ...
    public static void LeaveItemMapVIP(TileMap place, Mob mob3, int master) {
        ...
        try {
            ...
            } else if (Util.nextInt(3400) < 1) {
                im = place.LeaveItem((short) dakh[Util.nextInt(dakh.length)], mob3.x, mob3.y, mob3.templates.type, false);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void LeaveItemMapVVIP(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if (Util.nextInt(500) < 2) {
                im = place.LeaveItem((short) TrangBiXeSoi[Util.nextInt(TrangBiXeSoi.length)], mob3.x, mob3.y, mob3.templates.type, false);
            } else if (Util.nextInt(500) < 7) {
                im = place.LeaveItem((short) ExpXeSoi[Util.nextInt(ExpXeSoi.length)], mob3.x, mob3.y, mob3.templates.type, false);
    ...
    public static void LeaveItemMapSVIP(TileMap place, Mob mob3, int master) {
        ItemMap im = null;
        try {
            if (Util.nextInt(500) < 3) {
                im = place.LeaveItem((short) TrangBiXeSoi[Util.nextInt(TrangBiXeSoi.length)], mob3.x, mob3.y, mob3.templates.type, false);
            } else if (Util.nextInt(500) < 10) {
                im = place.LeaveItem((short) ExpXeSoi[Util.nextInt(ExpXeSoi.length)], mob3.x, mob3.y, mob3.templates.type, false);
        ...
        try {
            switch (Server.manager.event) {
                ...
                case EventName.DA_MA_THUAT: {
                    if (per < 9) {
                        im = place.LeaveItem(NLSKDANANGLUONG[Util.nextInt(NLSKDANANGLUONG.length)], mob3.x, mob3.y, mob3.templates.type, false);
                    }
                    break;
                }

            ...
            case 0: {
                ...
                switch (b3) {
                    ...
                    case 3: {
                        ...
                        Item Super = ItemTemplate.itemDefault(p.c.gender == 1 ? 407 : 408);
                    ...
                    case 4: {
                        ...
                        Item Super = ItemTemplate.itemDefault(p.c.gender == 1 ? 407 : 408);
                        Super.options.add(new Option(58, 10));
                        Super.options.add(new Option(73, 5000));
                        Super.options.add(new Option(6, 4000));
                        Super.options.add(new Option(94, 100));
                        Super.options.add(new Option(92, 100));
                        Super.options.add(new Option(79, 20));
                        Super.options.add(new Option(80, 200));
                        ...
                        PHB.sys = 4;
                        PHB.upgrade = 99;
                        PHB.options.add(new Option(58, 15));
                        PHB.options.add(new Option(87, 7500));
                        PHB.options.add(new Option(82, 5000));
                        PHB.options.add(new Option(57, 100));
                        PHB.options.add(new Option(94, 100));
                        PHB.options.add(new Option(99, 200));
                        PHB.options.add(new Option(8, 100));
                        PHB.options.add(new Option(9, 100));
                        PHB.options.add(new Option(67, 100));
                        PHB.options.add(new Option(69, 70));
                        PHB.options.add(new Option(68, 50));
                        PHB.options.add(new Option(74, 200));
                        PHB.options.add(new Option(119, 200));
                        PHB.options.add(new Option(120, 200));
                        PHB.options.add(new Option(130, 5));
                        PHB.options.add(new Option(131, 5));
...
//                        if (p.c.svip == 0) {
//                            Service.chatNPC(p, (short) npcid, "Bạn Phải Là S-VIP Mới Có Thể Vào Map Này");
//                            return;
//                        }
                        Map ma = Manager.getMapid(161);
                        for (TileMap area : ma.area) {
                            if (area.numplayers < ma.template.maxplayers) {
                                p.c.tileMap.leave(p);
                                area.EnterMap0(p.c);

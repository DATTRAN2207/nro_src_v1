...
public class BiKip {
    ...
    public static int[] Luong = new int[]{500, 1000, 1500, 2000, 3000, 3500, 4000, 5000, 5500, 6500, 7000, 7500, 8000, 8500, 9000, 10000}; // lượng
    public static int[] Xu = new int[]{100, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 8000}; // lượng
    // Options Bí Kíp
    ...
    public static void MenuUpgradeBiKip(Player p, byte npcid, byte menuId, byte b3) throws IOException {
        ...
        switch (menuId) {
            case 0: {
                ...
                if (p.luong < 1000) {
                    Service.chatNPC(p, (short) npcid,"Bạn không có đủ 1000 lượng");
                    return;
                }
                if (p.c.quantityItemyTotal(837) < 10 ) {
                                Service.chatNPC(p, (short) npcid,"Bạn không đủ đá nâng cấp.");
                                return;
                            }
